import { IsString, IsNotEmpty, IsOptional, IsBoolean, IsInt, IsDateString, MaxLength } from 'class-validator';
import { ApiProperty } from '@nestjs/swagger';
import { Transform } from 'class-transformer';

export class CrearSsProgramaDto {
  ...
  @ApiProperty({ example: 1, description: 'Id del tipo de programa' })
  @Transform(({ value }) => Number(value))
  @IsInt()
  @IsNotEmpty()
  id_tipo_programa: number;

  @ApiProperty({ example: 'Programa de Apoyo Comunitario', description: 'Nombre del programa' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(255)
  ...
  @ApiProperty({ example: 'Actividad 1, Actividad 2', description: 'Lista de actividades del programa' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(300)
